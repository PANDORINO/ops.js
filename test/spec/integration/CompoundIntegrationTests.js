describe("Compound search", function() {
  ...
  describe("multiple compound search", function() {
    ...
    it("can return a response", function() {
      ...
      var callback=function(success, status, response){
        this_success = success;
        this_status = status;
        this_result = searcher.parseCompoundsResponse(response);
      };
      waitsFor(function() {
        return this_result != null;
      });
      runs(function() {
        ...
        //expect(this_result[0].csURI).not.toBeNull();
        ...
        expect(this_result[0].drugbankURI).not.toBeNull();
